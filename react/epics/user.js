...
import {
    ACTION_CREATE_USER, ACTION_CREATE_USER_FULFILLED,
    ACTION_DELETE_USER,
    ACTION_DELETE_USER_FULFILLED,
    ACTION_FETCH_USER_LIST,
    ACTION_FETCH_USER_LIST_FULFILLED, ACTION_GET_USER_INFO, ACTION_GET_USER_INFO_FULFILLED, ACTION_LOGIN,
    ACTION_LOGIN_FULFILLED,
    ACTION_MODIFY_PASSWORD,
    ACTION_MODIFY_PASSWORD_FULFILLED, ACTION_MODIFY_PASSWORD_UID, ACTION_MODIFY_PASSWORD_UID_FULFILLED,
    ACTION_RESET_PASSWORD, ACTION_RESET_PASSWORD_FULFILLED,
    ACTION_UPDATE_USER_INFO, ACTION_UPDATE_USER_INFO_FULFILLED
} from "../constants/actionType";
import {AJAX_METHOD, ajaxRequest} from "../../util/ajax";
import {
    URL_CREATE_USER,
    URL_DELETE_USER, URL_FETCH_USER_LIST, URL_GET_USER_INFO, URL_LOGIN, URL_MODIFY_PWD, URL_RESET_PASSWORD,
